...
\scriptsize
\vspace*{1 cm}
\caption[Neoproterozoic large igneous provinces.]{Large igneous provinces included in the analysis conducted in the main text.}
\vspace{1 cm}
    \resizebox{\linewidth}{!}{
...
\scriptsize
\vspace*{1 cm}
\caption[Variables used in the global weathering model.]{Variables used in the global weathering model.}
\vspace{1 cm}
\resizebox{\linewidth}{!}{
	\begin{tabular}{l l c}
